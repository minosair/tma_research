...
// node_modules/.pnpm/@telegram-apps+sdk@1.1.1/node_modules/@telegram-apps/sdk/dist/index.js
var We = Object.defineProperty;
var Ue = (t, e, s) => e in t ? We(t, e, { enumerable: true, configurable: true, writable: true, value: s }) : t[e] = s;
...
var V = class _V extends Error {
  constructor(e, s, n) {
    super(s, { cause: n }), this.type = e, Object.setPrototypeOf(this, _V.prototype);
  }
};
function f(t, e, s) {
  return new V(t, e, s);
}
var ze = "ERR_METHOD_UNSUPPORTED";
var je = "ERR_METHOD_PARAMETER_UNSUPPORTED";
...
var ut = class {
  ...
  set(e, s) {
    Object.entries(typeof e == "string" ? { [e]: s } : e).reduce((r, [i, o]) => this.state[i] === o || o === void 0 ? r : (this.state[i] = o, this.ee.emit(`change:${i}`, o), true), false) && this.ee.emit("change", this.state);
  }
  /**
...
var lt = class extends Z {
  constructor(s, n, r) {
    ...
    c(this, "off", (s2, n2) => s2 === "click" ? B("back_button_pressed", n2) : this.state.off(s2, n2));
    this.postEvent = r;
  }
  set isVisible(s) {
...
var Ee = S((t) => t instanceof Date ? t : new Date(y().parse(t) * 1e3), "Date");
function K(t, e) {
  return new D((s) => {
...
var ps = l(
  ({ version: t, postEvent: e }) => new Nt(false, t, e)
);
var Vt = class extends Y {
  constructor({ postEvent: s, ...n }) {
    ...
    c(this, "off", (s2, n2) => s2 === "click" ? B("main_button_pressed", n2) : this.state.off(s2, n2));
    this.postEvent = s;
  }
  /**
...
var Bt = class extends P {
  constructor({ postEvent: s, createRequestId: n, version: r, botInline: i, ...o }) {
    ...
    this.supports = (h) => a(h) ? h !== "switchInlineQuery" || i : false, this.supportsParam = Ve(r, {
...
var ds = l(
  ({ postEvent: t, version: e }) => new $t(false, e, t)
);
...
var _s = l(
  ({ version: t, postEvent: e }) => new Wt(false, t, e)
);
var Ut = class extends Z {
  constructor(s, n, r) {
    ...
    c(this, "off", (s2, n2) => s2 === "click" ? B("settings_button_pressed", n2) : this.state.off(s2, n2));
    this.postEvent = r;
  }
  set isVisible(s) {
...
function Ps(t = true) {
  ...
  return A("iframe_ready", { reload_supported: true }), s;
}
function xs() {
